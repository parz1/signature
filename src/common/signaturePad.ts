...
export default class SignaturePad {
  ...
  constructor(canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D, options: {
    velocityFilterWeight: number, minWidth: number, maxWidth: number,
    throttle: number, minDistance: number, dotSize?: number, penColor?: string, backgroundColor?: string
  }) {
    // this.canvas = canvas;
